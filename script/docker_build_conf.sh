...
CWB_BUILD_DEPS='subversion autoconf bison flex libglib2.0-dev libncurses5-dev make binutils perl gcc g++ libc6-dev'
SNACK_BUILD_DEPS='curl make patch binutils perl gcc g++ libc6-dev tcl8.4-dev tk8.4-dev'
